document.addEventListener("DOMContentLoaded", () => {
  ...
  form.addEventListener("submit", async function (e) {
    ...
    try {
      ...
      doc.text("GISOU", 20, y); y += lineHeight;
      doc.text("Website: gisou.com", 20, y); y += lineHeight;
      doc.text("Instagram: @gisou", 20, y); y += lineHeight * 2;
  ...
  function afterDownloadSuccess(data) {
    try {
      ...
      if (emailLink) {
        ...
        emailLink.href = `mailto:gisoucollaboration@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
      }
    } catch (err) {
